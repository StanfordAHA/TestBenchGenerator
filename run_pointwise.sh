...
# png to raw
../CGRAFlow/CGRAGenerator/verilator/generator_z_tb/io/myconvert.csh inputs/pointwise.png io16in_in_arg_1_0_0.raw
../CGRAFlow/CGRAGenerator/verilator/generator_z_tb/io/myconvert.csh gold_outputs/pointwise.png gold_output.raw
