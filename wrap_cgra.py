...
parser.add_argument('--output-directory', help="Directory to place the compiled output", default=".")

args = parser.parse_args()

cgra = DefineTester(args.cgra_verilog,args.pnr_io_collateral, args.wrapper_module_name)
output_directory = args.output_directory
m.compile(os.path.join(output_directory, args.wrapper_module_name), cgra)
